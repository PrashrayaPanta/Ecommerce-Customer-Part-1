...
import { ClearStorage, FromStorage, imgURLForProduct } from "../library";
...
const Cart = () => {
  ...
  const handleDeleteCartItem = (id) => {
    console.log("This is inside delete cart Item function");
            ...
            {cart ? (
              <>
                ...
                <div className="mt-6 flex">
                  ...
                  <button
                    className="px-5 py-2.5 border hover:bg-red-600   rounded-lg  font-medium"
                    onClick={handleDeleteAllCartItems}
                  >
                    <i className="fas fa-sync-alt mr-2"></i> Clear Cart Items
                  </button>
                  {/* {Proccedd to checkout Button} */}
                  <button
                    className="px-5 py-2.5   hover:bg-red-500  rounded-lg"
